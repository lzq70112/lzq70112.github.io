...
heroText: 胸毛君
tagline: 空想而不实践，就是一场空
# actionText: 立刻进入 →
# actionLink: /web/
# bannerBg: auto # auto => 网格纹背景(有bodyBgImg时无背景)，默认 | none => 无 | '大图地址' | background: 自定义背景样式       提示：如发现文本颜色不适应你的背景时可以到palette.styl修改$bannerTextColor变量Z

#features: # 可选的
 ##  details: 肉体上勤奋，弥补不了思想上的懒惰
  # link: /web/ # 可选
    #imgUrl: /img/web.png # 可选
 # - title: 开发
  #  details: 目标-做个自动化处理报错的平台
   # link: /ui/
    #imgUrl: /img/ui.png
  #- title: 生活
   # details: 生活碎碎念
