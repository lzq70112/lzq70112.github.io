...
`
	...
	fmt.Printf("%T\n", strings.Split(s3, " "))
	fmt.Println(strings.Contains(s3, "11"))
	fmt.Println(strings.HasPrefix(s3, "11"))
	fmt.Println(strings.HasSuffix(s3, "33"))
	fmt.Println(strings.Index(s3, "22"))
	fmt.Println(strings.LastIndex(s3, "33"))
	s4 := []string{"44", "55"}
	fmt.Println(s4)
	fmt.Println(strings.Join(s4, "_"))
