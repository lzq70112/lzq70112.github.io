...
> 注意匿名函数需要传参数固定值，否则值不被拷贝的时候，会出现问题
...
![channel异常总结](https://cdn.jsdelivr.net/gh/lzq70112/images/blog/202202231522292.png)

关闭已经关闭的`channel`也会引发`panic`。

#### 3.4.8、worker pool（goroutine池）
