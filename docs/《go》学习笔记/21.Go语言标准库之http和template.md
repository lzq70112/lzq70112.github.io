---
title: Go语言标准库之http
date: 2022-04-18 22:35:26
permalink: /pages/go21/
categories:
  - 《go》学习笔记
tags:
  - go
...
func demo1(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		fmt.Println("parse faild err", err)
		return
	}
	name := "胸毛"
	t.Execute(w, name)
...
func main() {
	...
	if err != nil {
		fmt.Println("http server start faild", err)
		return
	}
}
...
![image-20220309150249165](https://cdn.jsdelivr.net/gh/lzq70112/images/blog/202203091502681.png)
...
## 6、text/template与html/tempalte的区别
